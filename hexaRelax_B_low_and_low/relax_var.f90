MODULE var_global
  ...
  CHARACTER (LEN = *), PARAMETER :: output_file          = 'run1/run1_'
  ...
  REAL(num), DIMENSION(:, :, :), ALLOCATABLE :: bbx_read, bby_read, bbz_read
  REAL(num), DIMENSION(:, :, :), ALLOCATABLE :: bbx_po, bby_po, bbz_po
  REAL(num), DIMENSION(:, :, :), ALLOCATABLE :: bbx_ff, bby_ff, bbz_ff
